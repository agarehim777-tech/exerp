...
GRANT SELECT, INSERT ON public.erp_reconciliation_reports TO authenticated;
...
DROP POLICY IF EXISTS erp_reconciliation_reports_insert ON public.erp_reconciliation_reports;
CREATE POLICY erp_reconciliation_reports_insert ON public.erp_reconciliation_reports
FOR INSERT TO authenticated
WITH CHECK (private.is_tenant_member(tenant_id, (SELECT auth.uid())));
